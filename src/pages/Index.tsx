      ...
      <main className="flex-grow">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 animate-fade-in">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  Find Your Perfect <span className="text-gradient">College Match</span>
                </h1>
                ...
                <div className="mt-10 flex flex-col sm:flex-row gap-4">
                  <CustomButton to="/career-selection" size="lg" variant="gleam" className="gap-2">
                    Get Started <ArrowRight size={16} />
                  </CustomButton>
                  <CustomButton to="/login" variant="neuro" size="lg">
                    Log In
                  </CustomButton>
                </div>
              </div>
              <div className="order-1 lg:order-2 flex justify-center lg:justify-end animate-fade-in">
                <BlurCard variant="gleam" className="p-0 overflow-hidden">
                  <img 
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                Why Choose <span className="text-gradient">Campus Navigator</span>?
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature, index) => (
                <div 
                  ...
                  className="opacity-0 shimmer"
                  style={{ transitionDelay: `${index * 100}ms` }}
                >
                  <BlurCard variant={index % 2 === 0 ? "gleam" : "neuro"} hoverEffect className="h-full">
        ...
        <section className="py-20 px-6 md:px-12 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10">
            <BlurCard variant="gleam" className="max-w-4xl mx-auto py-12">
              ...
              <CustomButton to="/career-selection" variant="gleam" size="lg" className="gap-2 mx-auto">
